                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('fournisseurs.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="number" class="form-control @error('tel') is-invalid @enderror" name="tel" required autocomplete="new-password">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="adresse" type="text" class="form-control @error('adresse') is-invalid @enderror" name="adresse" required autocomplete="new-password">
